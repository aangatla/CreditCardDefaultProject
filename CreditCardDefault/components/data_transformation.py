from CreditCardDefault.entity import artifact_entity,config_entity
...
import pandas as pd
from CreditCardDefault import utils
import numpy as np
from imblearn.combine import SMOTETomek
from sklearn.preprocessing import RobustScaler
from CreditCardDefault.entity.config_entity import TARGET_COLUMN
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> artifact_entity.DataTransformationArtifact:
        try:
            ...
            #renaming the categorical value in Marriage column:
            train_df.loc[:, 'MARRIAGE'] = train_df.loc[:, 'MARRIAGE'].replace(0, 3)
            test_df.loc[:,'MARRIAGE'] = test_df.loc[:,'MARRIAGE'].replace(0,3)
